...
export const ITEMS: Record<string, ItemEffect> = {
  ...
  "Floettite": { name: "Floettite", description: "Mega Evolves Floette.", isMegaStone: true, forPokemon: "Eternal Floette" },
  ...
  "Barbaracite": { name: "Barbaracite", description: "Mega Evolves Barbaracle.", isMegaStone: true, forPokemon: "Barbaracle" },
  ...
  "Scolipite": { name: "Scolipite", description: "Mega Evolves Scolipede.", isMegaStone: true, forPokemon: "Scolipede" },
  "Scraftinite": { name: "Scraftinite", description: "Mega Evolves Scrafty.", isMegaStone: true, forPokemon: "Scrafty" },
...
// Mirrors the official Pokémon Champions held-item list for Regulation M-B; the 12 items added in M-C are not enabled yet.
